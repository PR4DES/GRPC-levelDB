...
class ReadResult : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ycsbleveldb.ReadResult) */ {
 public:
  ...
  inline ReadResult* New() const PROTOBUF_FINAL { return New(NULL); }

  ReadResult* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
 ...
 private:
  ...
  mutable int _cached_size_;
  friend struct ::protobuf_leveldb_5fycsb_2eproto::TableStruct;
  friend void ::protobuf_leveldb_5fycsb_2eproto::InitDefaultsReadResultImpl();
};
// ===================================================================
