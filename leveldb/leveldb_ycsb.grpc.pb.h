 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status Read(::grpc::ClientContext* context, const ::ycsbleveldb::ReadM& request, ::ycsbleveldb::Result* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::ycsbleveldb::Result>> AsyncRead(::grpc::ClientContext* context, const ::ycsbleveldb::ReadM& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::ycsbleveldb::Result>>(AsyncReadRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::ycsbleveldb::Result>> PrepareAsyncRead(::grpc::ClientContext* context, const ::ycsbleveldb::ReadM& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::ycsbleveldb::Result>>(PrepareAsyncReadRaw(context, request, cq));
    }
  ...
  private:
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::ycsbleveldb::Result>* AsyncReadRaw(::grpc::ClientContext* context, const ::ycsbleveldb::ReadM& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::ycsbleveldb::Result>* PrepareAsyncReadRaw(::grpc::ClientContext* context, const ::ycsbleveldb::ReadM& request, ::grpc::CompletionQueue* cq) = 0;
  ...
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status Read(::grpc::ClientContext* context, const ::ycsbleveldb::ReadM& request, ::ycsbleveldb::Result* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::ycsbleveldb::Result>> AsyncRead(::grpc::ClientContext* context, const ::ycsbleveldb::ReadM& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::ycsbleveldb::Result>>(AsyncReadRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::ycsbleveldb::Result>> PrepareAsyncRead(::grpc::ClientContext* context, const ::ycsbleveldb::ReadM& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::ycsbleveldb::Result>>(PrepareAsyncReadRaw(context, request, cq));
    }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::ycsbleveldb::Result>* AsyncReadRaw(::grpc::ClientContext* context, const ::ycsbleveldb::ReadM& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::ycsbleveldb::Result>* PrepareAsyncReadRaw(::grpc::ClientContext* context, const ::ycsbleveldb::ReadM& request, ::grpc::CompletionQueue* cq) override;
  ...
  class Service : public ::grpc::Service {
   public:
    Service();
    virtual ~Service();
    virtual ::grpc::Status Read(::grpc::ServerContext* context, const ::ycsbleveldb::ReadM* request, ::ycsbleveldb::Result* response);
  ...
  class WithAsyncMethod_Read : public BaseClass {
   ...
   public:
    ...
    ::grpc::Status Read(::grpc::ServerContext* context, const ::ycsbleveldb::ReadM* request, ::ycsbleveldb::Result* response) final override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestRead(::grpc::ServerContext* context, ::ycsbleveldb::ReadM* request, ::grpc::ServerAsyncResponseWriter< ::ycsbleveldb::Result>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
   ...
   public:
    WithStreamedUnaryMethod_Read() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::internal::StreamedUnaryHandler< ::ycsbleveldb::ReadM, ::ycsbleveldb::Result>(std::bind(&WithStreamedUnaryMethod_Read<BaseClass>::StreamedRead, this, std::placeholders::_1, std::placeholders::_2)));
    }
    ...
    virtual ::grpc::Status StreamedRead(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::ycsbleveldb::ReadM,::ycsbleveldb::Result>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
