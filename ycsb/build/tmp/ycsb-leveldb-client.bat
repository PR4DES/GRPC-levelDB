...
set CLASSPATH=%APP_HOME%\lib\examples.jar;%APP_HOME%\lib\grpc-netty-1.0.1.jar;%APP_HOME%\lib\grpc-protobuf-1.0.1.jar;%APP_HOME%\lib\grpc-stub-1.0.1.jar;%APP_HOME%\lib\json-simple-1.1.1.jar;%APP_HOME%\lib\core-0.1.4.jar;%APP_HOME%\lib\netty-codec-http2-4.1.3.Final.jar;%APP_HOME%\lib\grpc-core-1.0.1.jar;%APP_HOME%\lib\guava-19.0.jar;%APP_HOME%\lib\protobuf-java-3.0.0.jar;%APP_HOME%\lib\protobuf-java-util-3.0.0.jar;%APP_HOME%\lib\grpc-protobuf-lite-1.0.1.jar;%APP_HOME%\lib\junit-4.10.jar;%APP_HOME%\lib\jackson-mapper-asl-1.9.4.jar;%APP_HOME%\lib\jackson-core-asl-1.9.4.jar;%APP_HOME%\lib\checkstyle-5.0.jar;%APP_HOME%\lib\jdom-1.1.jar;%APP_HOME%\lib\google-collections-1.0.jar;%APP_HOME%\lib\slf4j-api-1.6.4.jar;%APP_HOME%\lib\netty-codec-http-4.1.3.Final.jar;%APP_HOME%\lib\netty-handler-4.1.3.Final.jar;%APP_HOME%\lib\grpc-context-1.0.1.jar;%APP_HOME%\lib\jsr305-3.0.0.jar;%APP_HOME%\lib\gson-2.3.jar;%APP_HOME%\lib\hamcrest-core-1.1.jar;%APP_HOME%\lib\antlr-2.7.6.jar;%APP_HOME%\lib\commons-beanutils-core-1.7.0.jar;%APP_HOME%\lib\commons-cli-1.0.jar;%APP_HOME%\lib\commons-logging-1.0.3.jar;%APP_HOME%\lib\netty-codec-4.1.3.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.3.Final.jar;%APP_HOME%\lib\netty-transport-4.1.3.Final.jar;%APP_HOME%\lib\commons-collections-2.0.jar;%APP_HOME%\lib\commons-lang-1.0.jar;%APP_HOME%\lib\netty-common-4.1.3.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.3.Final.jar
